...
// ================= CLEAN CORE PATCH (NO CRASH VERSION) =================
...
// UI button safe render
function renderBackupCard(){
  return `<div class="dashboard-primary-card green" onclick="exportBackup()">
  📦 بکاپ و خروجی
  </div>`;
}
